...
public sealed class MedicosMeDisponibilidadeController : ControllerBase
{
    ...
    public async Task<IActionResult> Disponibilidade([FromQuery] DateTime? inicio, [FromQuery] DateTime? fim) { var r = await service.ListarDisponibilidadesAsync(Uid(), inicio, fim); return StatusCode(r.StatusCode, r); }
