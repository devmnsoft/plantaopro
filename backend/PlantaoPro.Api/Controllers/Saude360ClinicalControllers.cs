...
public sealed class ConsultasController : ControllerBase
{
    ...
    [HttpPost("{id:guid}/iniciar-legado")] public async Task<IActionResult> Iniciar(Guid id, [FromBody] Saude360ActionRequest request) { var r = await service.AcaoAsync("consultas", id, "iniciar", request); return StatusCode(r.StatusCode, r); }
    ...
    [HttpPost("{id:guid}/finalizar-legado")] public async Task<IActionResult> Finalizar(Guid id, [FromBody] Saude360ActionRequest request) { var r = await service.AcaoAsync("consultas", id, "finalizar", request); return StatusCode(r.StatusCode, r); }
