...
builder.Services.AddScoped<IValorizacaoRepository>(_=>new ValorizacaoRepository(connectionString!));
builder.Services.AddScoped<IVendaRepository>(_=>new VendaRepository(connectionString!));
builder.Services.AddScoped<IContasReceberRepository>(_=>new ContasReceberRepository(connectionString!));
builder.Services.AddScoped<IContasPagarRepository>(_=>new ContasPagarRepository(connectionString!));
builder.Services.AddScoped<ICaixaRepository>(_=>new CaixaRepository(connectionString!));
builder.Services.AddScoped<IAdm360FinanceiroRelatoriosRepository>(_=>new Adm360FinanceiroRelatoriosRepository(connectionString!));
