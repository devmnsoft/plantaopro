#!/usr/bin/env python3
"""Verifica o contrato responsivo e acessível dos formulários críticos v1.70."""
...
print("Form experience v1.70 validada: pp-form, grid, ajuda, erros e associação acessível presentes.")
