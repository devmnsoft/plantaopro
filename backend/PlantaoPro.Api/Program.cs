...
builder.Services.AddScoped<ICotacoesRepository>(_=>new CotacoesRepository(connectionString!));
builder.Services.AddScoped<IDocumentosXmlRepository>(_=>new DocumentosXmlRepository(connectionString!));
builder.Services.AddScoped<IGestaoDashboardRepository>(_=>new GestaoDashboardRepository(connectionString!));
