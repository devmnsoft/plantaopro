...
public class NotificacoesController : ControllerBase{ private readonly NotificacaoService service; public NotificacoesController(NotificacaoService service){ this.service=service; }
