...
public sealed class FechamentoWebDto
{
    ...
    public IReadOnlyList<FechamentoPendenciaWebDto> Pendencias{get;set;}=Array.Empty<FechamentoPendenciaWebDto>(); public decimal TotalAjustes{get;set;} public decimal TotalFinal{get;set;} public bool PodeFechar{get;set;} public string CriterioCompetencia{get;set;}="";
}
public sealed class FechamentoItemWebDto{public Guid Id{get;set;}public Guid EscalaId{get;set;}public string Medico{get;set;}="";public string Crm{get;set;}="";public string StatusEscala{get;set;}="";public DateTime InicioPrevisto{get;set;}public DateTime FimPrevisto{get;set;}public decimal HorasPrevistas{get;set;}public decimal HorasRealizadas{get;set;}public decimal ValorPrevisto{get;set;}public decimal ValorApurado{get;set;}public bool PossuiDivergencia{get;set;}public Guid? PagamentoId{get;set;}public string? PagamentoStatus{get;set;}public string BaseCalculo{get;set;}="";public string RegraAplicada{get;set;}="";public DateTime VigenciaInicio{get;set;}public decimal QuantidadeConsiderada{get;set;}public string Arredondamento{get;set;}="";}
public sealed class FechamentoPendenciaWebDto{public string Codigo{get;set;}="";public string Mensagem{get;set;}="";public string Severidade{get;set;}="";public Guid? EscalaId{get;set;}}
