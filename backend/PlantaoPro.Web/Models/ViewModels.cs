...
namespace PlantaoPro.Web.Models
{
    ...
    public record LoginResponse(string Token, DateTime ExpiresAt, Guid UsuarioId, string Nome, string Email, string[]? Roles, Guid? ClienteId = null, string? ClienteNome = null, Guid? TenantId = null, string? TenantNome = null, bool MustChangePassword = false, string? PrimaryRole = null, string? AccessScope = null, bool TenantContextRequired = false, bool TenantContextSelected = false, Guid? TenantContextId = null, string? ContextMode = null, string? SessionId = null, string[]? Permissions = null, string[]? Modules = null, string? ClienteStatus = null);
...
public record ProfessionalAgendaPageViewModel(IReadOnlyList<ProfessionalShiftDto> Items,string? ErrorMessage,DateOnly Inicio,DateOnly Fim,string? Unidade,string? Situacao,string Visualizacao);
public record MedicoPagamentoDto(Guid PagamentoId,string HospitalNome,string EspecialidadeNome,DateTime DataPlantao,decimal ValorPrevisto,decimal? ValorPago,string Status,DateOnly? DataPrevista,DateOnly? DataPagamento,string? FormaPagamento,decimal ValorApurado,decimal? ValorAprovado,decimal Saldo,decimal HorasReferencia,decimal ValorHora,Guid? EscalaId,Guid? FechamentoId,string? FechamentoStatus,string? ContestacaoStatus);
...
public record ManagerSubstitutionDto(Guid Id,Guid PlantaoId,Guid? EscalaId,Guid MedicoSolicitanteId,Guid? MedicoSubstitutoId,string MedicoSolicitanteNome,Guid HospitalId,string HospitalNome,string EspecialidadeNome,DateTime DataInicio,DateTime DataFim,string Motivo,string Status,DateTime RegDate,long Versao);
public record ManagerRequestQueueViewModel(IReadOnlyList<ManagerSubstitutionDto> Items,string? Error,string? Status,Guid? UnidadeId,DateOnly? Inicio,DateOnly? Fim,string? Profissional,int Page,int PageSize,long Total)
{
...
public record DashboardChartItem(string Label, decimal Valor);
    ...
    public record PagamentoResumoDto(Guid Id, Guid EscalaId, Guid MedicoId, Guid PlantaoId, Guid HospitalId, Guid EspecialidadeId, string MedicoNome, string MedicoCrm, string HospitalNome, string EspecialidadeNome, DateTime DataPlantao, decimal ValorPrevisto, decimal? ValorPago, decimal ValorBruto, decimal? ValorLiquido, decimal Descontos, decimal Acrescimos, string Status, DateOnly? DataPrevista, DateOnly? DataPagamento, string? FormaPagamento, string? ChavePix, string? Observacoes, DateTime RegDate);
