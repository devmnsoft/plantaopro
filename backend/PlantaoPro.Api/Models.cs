...
public record CancelarCorrecaoPresencaRequest(long VersaoCorrecao,long VersaoPresenca);
...
public record ExecutionConferenceFilter(DateOnly? Inicio,DateOnly? Fim,Guid? UnidadeId,Guid? ProfissionalId,string? Status,bool? Divergencia,int Page=1,int PageSize=25);
...
public record DecideExecutionCorrectionRequest(Guid PresencaId,bool Aprovar,string Justificativa,long Versao);
