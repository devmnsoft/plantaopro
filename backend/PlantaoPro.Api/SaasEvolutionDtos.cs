...
public sealed class LgpdRetencaoDto
{
    public Guid Id { get; set; }
...
public sealed class JornadaEventoDto
{
    ...
    public string EtapaNova { get; set; } = string.Empty;
    public string Tipo { get; set; } = string.Empty;
    public string Resumo { get; set; } = string.Empty;
    public DateTime RegDate { get; set; }
}
...
public sealed class CriarEventoJornadaRequest
{
    public string Tipo { get; set; } = string.Empty;
    public string Resumo { get; set; } = string.Empty;
}

public sealed class CriarTarefaJornadaRequest
{
    public string Titulo { get; set; } = string.Empty;
...
public sealed class FunilItemDto
{
    public string Etapa { get; set; } = string.Empty;
...
public sealed class PerderOportunidadeRequest
{
    public string Motivo { get; set; } = string.Empty;
}
...
public sealed class PlanoSugeridoDto
{
    ...
    public IEnumerable<string> RecursosRecomendados { get; set; } = Array.Empty<string>();
}
...
public sealed class AjudaChecklistDto
{
    public Guid Id { get; set; }
    public string Perfil { get; set; } = string.Empty;
    public string Titulo { get; set; } = string.Empty;
