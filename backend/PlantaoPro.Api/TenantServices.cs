...
public sealed class PermissionGuardService
{
    private static readonly Dictionary<string, string[]> FallbackPermissoes = new Dictionary<string, string[]>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["PARCEIRO"] = new[] { PermissionConstants.RelatoriosVer },
        ["SUPORTE"] = new[] { PermissionConstants.SuporteVer, PermissionConstants.AuditoriaVer },
        ["AUDITOR"] = new[] { PermissionConstants.AuditoriaVer, PermissionConstants.RelatoriosVer },
        ["COMERCIAL"] = new[] { PermissionConstants.ClientesGerenciar, PermissionConstants.RelatoriosVer },
        ["CUSTOMER_SUCCESS"] = new[] { PermissionConstants.ClientesGerenciar, PermissionConstants.RelatoriosVer }
    };
