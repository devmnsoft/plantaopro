...
public sealed class V2167ExecutionConferenceContractTests
{
 ...
 [Fact] public void Correction_preserves_original_and_blocks_self_approval(){var s=Read("backend/PlantaoPro.Api/ExecutionConferenceService.cs");Assert.Contains("correction.SolicitadoPor == context.User",s);Assert.Contains("valores_anteriores",s);Assert.Contains("AJUSTE_POS_APURACAO",s);Assert.Contains("correction.Versao != request.Versao",s);}
