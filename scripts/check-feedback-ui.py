#!/usr/bin/env python3
"""Valida feedback acessível e impede atalhos visuais proibidos na v1.70."""
...
print("Feedback UI v1.70 validado: toast e confirmação acessíveis, sem APIs nativas ou CSS minificado novo.")
