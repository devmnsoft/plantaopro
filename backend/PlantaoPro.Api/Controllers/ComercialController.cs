...
public sealed class ComercialController : ControllerBase
{
    ...
    public async Task<IActionResult> CriarOportunidade([FromBody] ComercialOportunidadeRequest request) { var r = await service.SalvarOportunidadeAsync(null, request); return StatusCode(r.StatusCode, r); }
    [HttpPut("oportunidades/{id:guid}")]
    public async Task<IActionResult> EditarOportunidade(Guid id, [FromBody] ComercialOportunidadeRequest request) { var r = await service.SalvarOportunidadeAsync(id, request); return StatusCode(r.StatusCode, r); }
    [HttpPost("oportunidades/{id:guid}/ganhar")]
    public async Task<IActionResult> Ganhar(Guid id) { try { var r = await service.GanharOportunidadeAsync(id); return StatusCode(r.StatusCode, r); } catch (Exception ex) { logger.LogError(ex, "Erro ganhar oportunidade"); return StatusCode(500, ApiResponse<string>.Fail("Não foi possível ganhar oportunidade.", 500)); } }
    [HttpPost("oportunidades/{id:guid}/perder")]
    public async Task<IActionResult> Perder(Guid id, [FromBody] StatusComMotivoRequest request) { try { var r = await service.PerderOportunidadeAsync(id, request); return StatusCode(r.StatusCode, r); } catch (Exception ex) { logger.LogError(ex, "Erro perder oportunidade"); return StatusCode(500, ApiResponse<string>.Fail("Não foi possível perder oportunidade.", 500)); } }
    [HttpGet("propostas")]
    public async Task<IActionResult> Propostas() { var r = await service.PropostasAsync(); return StatusCode(r.StatusCode, r); }
    [HttpPost("propostas")]
    public async Task<IActionResult> CriarProposta([FromBody] ComercialPropostaRequest request) { try { var r = await service.CriarPropostaAsync(request, User.IsInRole(RolesConstants.AdministradorGlobal)); return StatusCode(r.StatusCode, r); } catch (Exception ex) { logger.LogError(ex, "Erro proposta"); return StatusCode(500, ApiResponse<string>.Fail("Não foi possível criar proposta.", 500)); } }
    [HttpPost("propostas/{id:guid}/enviar")]
    public async Task<IActionResult> Enviar(Guid id) { var r = await service.AlterarStatusPropostaAsync(id, "ENVIADA"); return StatusCode(r.StatusCode, r); }
    [HttpPost("propostas/{id:guid}/aprovar")]
    public async Task<IActionResult> Aprovar(Guid id) { var r = await service.AlterarStatusPropostaAsync(id, "APROVADA"); return StatusCode(r.StatusCode, r); }
    [HttpPost("propostas/{id:guid}/recusar")]
    public async Task<IActionResult> Recusar(Guid id) { var r = await service.AlterarStatusPropostaAsync(id, "RECUSADA"); return StatusCode(r.StatusCode, r); }
    [HttpGet("funil")]
    public async Task<IActionResult> Funil() { var r = await service.OportunidadesAsync(); return StatusCode(r.StatusCode, r); }
    [HttpGet("previsao-receita")]
    public async Task<IActionResult> PrevisaoReceita() { var r = await service.OportunidadesAsync(); return StatusCode(r.StatusCode, r); }
