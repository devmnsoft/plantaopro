...
{
    public IReadOnlyList<FechamentoWebDto> Fechamentos { get; set; }=[];
    public FechamentoWebDto? Selecionado { get; set; }
    public IReadOnlyList<FechamentoTimelineWebDto> Timeline { get; set; }=[];
...
public sealed class FechamentoWebDto
{
    ...
    public int DivergenciasAbertas{get;set;} public DateTime CriadoEm{get;set;} public IReadOnlyList<FechamentoItemWebDto> Itens{get;set;}=[]; public IReadOnlyList<FechamentoDivergenciaWebDto> Divergencias{get;set;}=[];
}
